...
import aboutBanner from '../../public/background/about_bg.png'
    ...
    <div>
      <div style={{
          ...
          <div className='banner-content'>
              <h1 className='mx-10 px-10 text-5xl md:text-6xl lg:text-8xl font-medium text-center leading-[4.5rem]'>About Mina</h1>
